...
include_once "WxPay.JsApiPay.php";
/**
 * 
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		{
		    //TODO 如果是签名错误 1 参数名ASCII码未按升序排列  2 商户ApiKey错误
        ...
        {
            $prePayParams['code_url']	=$result['code_url'];
        }
	...
	public static function shorturl($inputObj, $timeOut = 6)
	{
 	 ...
 	 */
	public static function notify($callback, &$msg , $input)
	{
		//获取通知的数据
		$xml = $input;
		//如果返回成功则验证签名
