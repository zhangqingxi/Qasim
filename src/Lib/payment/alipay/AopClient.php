<?php
include_once 'AopConfig.php';
include_once 'AopEncrypt.php';
include_once 'SignData.php';
include_once 'AlipayTradeAppPayRequest.php';
include_once 'AlipayTradeWapPayRequest.php';
include_once 'AlipayTradePagePayRequest.php';
include_once 'AlipayTradeRefundRequest.php';
include_once 'AlipayTradeFastpayRefundQueryRequest.php';
include_once 'AlipayTradeQueryRequest.php';
...
class AopClient {
    ...
    {
        $this -> appId = AopConfig::ALIPAY_APPID;
        $this -> rsaPrivateKey = AopConfig::PRIVATE_KEY;
        $this -> alipayrsaPublicKey = AopConfig::PUBLIC_KEY;
    }
